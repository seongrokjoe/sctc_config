...
public partial class XmlFunctionFileItemViewModel : ObservableObject
{
    public XmlFunctionFileModel Model { get; }
    ...
    public XmlFunctionFileItemViewModel(XmlFunctionFileModel model)
    {
        Model = model;
...
public class XmlFunctionPanelViewModel : ObservableObject
{
    public ObservableCollection<XmlFunctionFileItemViewModel> Items { get; } = new();
}
